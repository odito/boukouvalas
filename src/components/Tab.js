 ...
 <div className="tab">
  ...
  <div className="tab-center">
      ...
      <div className="single-tab  tab-media ">
       ...
       <li> <a href="https://www.gmailcc.com"><i className="fas fa-envelope-square media"></i></a></li>
       <li> <a href="https://www.facebook.com"><i className="fab fa-facebook-square media"></i></a></li>
        <li><a href="https://www.youtube"><i className="fab fa-youtube-square media"></i></a></li>
